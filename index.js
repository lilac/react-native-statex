...
var StateXModule = NativeModules.StateX;

/**
 * StateX is a simple, asynchronous, persistent, global, key-value storage system for app states.
 *
 * It is recommended that you use an abstraction on top of StateX instead of StateX
...
var StateX = {
  ...
  getItem: function(
    ...
    return new Promise((resolve, reject) => {
      StateXModule.multiGet([key], function(error, result) {
  ...
  setItem: function(
    ...
    return new Promise((resolve, reject) => {
      StateXModule.multiSet([[key,value]], function(error) {
  ...
  removeItem: function(
    ...
    return new Promise((resolve, reject) => {
      StateXModule.multiRemove([key], function(error) {
        callback && callback((error && convertError(error)) || null);
        if (error) {
          reject(convertError(error));
        } else {
  ...
  mergeItem: function(
    ...
    return new Promise((resolve, reject) => {
      StateXModule.multiMerge([[key,value]], function(error) {
        callback && callback((error && convertError(error)) || null);
        if (error) {
          reject(convertError(error));
        } else {
  ...
  /**
   * Erases *all* StateX for all clients, libraries, etc.  You probably
   * don't want to call this - use removeItem or multiRemove to clear only your
   * own keys instead. Returns a `Promise` object.
   */
  clear: function(callback?: ?(error: ?Error) => void): Promise {
    return new Promise((resolve, reject) => {
      StateXModule.clear(function(error) {
  ...
  getAllKeys: function(callback?: ?(error: ?Error, keys: ?Array<string>) => void): Promise {
    return new Promise((resolve, reject) => {
      StateXModule.getAllKeys(function(error, keys) {
  ...
  multiGet: function(
    ...
    return new Promise((resolve, reject) => {
      StateXModule.multiGet(keys, function(error, result) {
  ...
  multiSet: function(
    ...
    return new Promise((resolve, reject) => {
      StateXModule.multiSet(keyValuePairs, function(error) {
        callback && callback((error && convertError(error)) || null);
        if (error) {
          reject(convertError(error));
        } else {
  ...
  multiRemove: function(
    ...
    return new Promise((resolve, reject) => {
      StateXModule.multiRemove(keys, function(error) {
        callback && callback((error && convertError(error)) || null);
        if (error) {
          reject(convertError(error));
        } else {
  ...
  multiMerge: function(
    ...
    return new Promise((resolve, reject) => {
      StateXModule.multiMerge(keyValuePairs, function(error) {
        callback && callback((error && convertError(error)) || null);
        if (error) {
          reject(convertError(error));
        } else {
